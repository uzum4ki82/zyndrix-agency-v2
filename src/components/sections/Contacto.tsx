...
import { Send, Twitter, Linkedin, Facebook, Instagram, Share2, ShieldCheck, FileText, Lock } from 'lucide-react';
...
export const Contacto = () => (
    <section id="contacto" className="py-80 px-10 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 flex flex-col md:flex-row gap-40">
            ...
            <div className="md:w-1/2">
                <form className="glass-premium p-16 rounded-[4.5rem] border border-white/5 flex flex-col gap-10 relative overflow-hidden">
